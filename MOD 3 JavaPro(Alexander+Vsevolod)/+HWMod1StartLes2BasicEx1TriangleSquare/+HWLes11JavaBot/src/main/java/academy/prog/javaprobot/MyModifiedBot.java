...
@Component
public class MyModifiedBot extends TelegramLongPollingBot {

    private final static int USER_COUNT = 100;
    private final BotCredentials botCredentials;
    private final UserService userService;

    public MyModifiedBot(TelegramBotsApi telegramBotsApi,
    ...
    public void onUpdateReceived(Update update) {
        ...
        if (userOpt.isPresent()) {
            ...
            sendPicture(chatId, "src/pic/46b1b9f73493e5ca6e0b2ebf30b4de60.jpg");
